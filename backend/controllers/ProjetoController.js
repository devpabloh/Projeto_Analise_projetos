...
class ProjetoController {
    async create(req, res) {
        try {
            ...
            // Criar status de desenvolvimento
            ...
            // Criar ambiente de implementação
            ...
            await Documentacao.create({
                possui_documentacao: documentacao.possui_documentacao,
                tipos_documentos: documentacao.tipos_documentos,
                outros_documentos: documentacao.outros_documentos,
                documentacao_atualizada: documentacao.documentacao_atualizada,
                projeto_id: infoGerais.id
            });

            // Criar equipe e suporte
            await EquipeESuporte.create({
                ...
                suporte_disponivel: equipe_suporte.suporte_disponivel,
                horario_suporte: equipe_suporte.horario_suporte,
                projeto_id: infoGerais.id
            });

            // Criar segurança e conformidade
